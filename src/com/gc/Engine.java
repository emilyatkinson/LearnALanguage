...
public class Engine {
	...
	public Holder ourEngine(Holder ourHolder, String[] languageLevel) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
		...
		ourHolder = Replacer.replaceRandomTargetedSentencesWithTranslations(ourHolder);
